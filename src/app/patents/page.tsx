      ...
      <section className="px-6 py-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {/* Patent Card 1 */}
            <a href="/patents/1" className="bg-white/95 backdrop-blur-sm rounded-xl p-4 hover:shadow-xl transition-all duration-300 cursor-pointer transform hover:-translate-y-1">
            ...
            {/* Patent Card 2 */}
            <a href="/patents/2" className="bg-white/95 backdrop-blur-sm rounded-xl p-4 hover:shadow-xl transition-all duration-300 cursor-pointer transform hover:-translate-y-1">
            ...
            {/* Patent Card 3 */}
            <a href="/patents/3" className="bg-white/95 backdrop-blur-sm rounded-xl p-4 hover:shadow-xl transition-all duration-300 cursor-pointer transform hover:-translate-y-1">
            ...
            {/* Patent Card 4 */}
            <a href="/patents/4" className="bg-white/95 backdrop-blur-sm rounded-xl p-4 hover:shadow-xl transition-all duration-300 cursor-pointer transform hover:-translate-y-1">
            ...
            {/* Patent Card 5 */}
            <a href="/patents/5" className="bg-white/95 backdrop-blur-sm rounded-xl p-4 hover:shadow-xl transition-all duration-300 cursor-pointer transform hover:-translate-y-1">
            ...
            {/* Patent Card 6 */}
            <a href="/patents/6" className="bg-white/95 backdrop-blur-sm rounded-xl p-4 hover:shadow-xl transition-all duration-300 cursor-pointer transform hover:-translate-y-1">
            ...
            {/* Patent Card 7 */}
            <a href="/patents/7" className="bg-white/95 backdrop-blur-sm rounded-xl p-4 hover:shadow-xl transition-all duration-300 cursor-pointer transform hover:-translate-y-1">
              <div className="bg-yellow-100 rounded-full w-10 h-10 flex items-center justify-center mb-3">
                <span className="text-yellow-600 text-lg">⚡</span>
              </div>
              <h3 className="font-bold text-[#1a365d] mb-2 text-sm">고효율 태양광 패널 기술</h3>
              <p className="text-gray-600 text-xs mb-3">차세대 태양광 패널로 에너지 효율성을 극대화합니다.</p>
              <div className="flex justify-between items-center mb-2">
                <span className="font-bold text-base text-[#1a365d]">₩22,000,000</span>
                <span className="bg-green-100 text-green-800 px-2 py-1 rounded-full text-xs">판매중</span>
              </div>
              <p className="text-gray-500 text-xs mb-3">태양광</p>
              <div className="flex gap-2">
                <button className="text-gray-400 hover:text-red-500 transition-colors text-sm">❤️</button>
                <button className="text-gray-400 hover:text-blue-500 transition-colors text-sm">📤</button>
              </div>
            ...
            {/* Patent Card 8 */}
            <a href="/patents/8" className="bg-white/95 backdrop-blur-sm rounded-xl p-4 hover:shadow-xl transition-all duration-300 cursor-pointer transform hover:-translate-y-1">
              <div className="bg-red-100 rounded-full w-10 h-10 flex items-center justify-center mb-3">
                <span className="text-red-600 text-lg">🧬</span>
              </div>
              <h3 className="font-bold text-[#1a365d] mb-2 text-sm">유전자 편집 기술 특허</h3>
              <p className="text-gray-600 text-xs mb-3">정밀한 유전자 편집으로 질병 치료를 혁신합니다.</p>
              <div className="flex justify-between items-center mb-2">
                <span className="font-bold text-base text-[#1a365d]">₩45,000,000</span>
                <span className="bg-yellow-100 text-yellow-800 px-2 py-1 rounded-full text-xs">예약중</span>
              </div>
              <p className="text-gray-500 text-xs mb-3">유전자</p>
              <div className="flex gap-2">
                <button className="text-gray-400 hover:text-red-500 transition-colors text-sm">❤️</button>
                <button className="text-gray-400 hover:text-blue-500 transition-colors text-sm">📤</button>
              </div>
